...
type Repository interface {
	...
	CreateVersion(ctx context.Context, version *itemdomain.ItemVersion) error
}
...
func (r *postgresRepo) CreateVersion(ctx context.Context, version *itemdomain.ItemVersion) error {
